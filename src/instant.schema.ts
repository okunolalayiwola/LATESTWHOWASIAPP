...
const _schema = i.schema({
  entities: {
    ...
    personaProfiles: i.entity({
      ...
      careerSummary:     i.string().optional(),
      education:         i.string().optional(),
      personalityTraits: i.string().optional(),
      senseOfHumor:      i.string().optional(),
      catchphrases:      i.string().optional(),
      speechStyle:       i.string().optional(),
