...
const _schema = i.schema({
  entities: {
    ...
    memorials: i.entity({
      ...
      // Talk-with portrait — generated by Nano-Banana (Gemini 2.5 Flash Image) from 5 reference face photos.
      // Used in TalkScreen + ConversationPage. Falls back to memorial.photo (cover) if not present.
      faceTrainingUrls:       i.json().optional(),     // string[] — Cloudinary URLs of the 5 face reference photos
      talkPortraitUrl:        i.string().optional(),   // Cloudinary URL of the generated portrait
      talkPortraitAt:         i.number().optional(),   // when the portrait was last generated (ms epoch)
